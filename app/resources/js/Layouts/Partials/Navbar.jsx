		...
		<>
			<nav className="fixed left-0 top-0 z-50 hidden w-full flex-row justify-between border-b-[1px] bg-white px-12 py-5 shadow dark:bg-[#1F1F1F] md:flex">
				...
				<div className="flex flex-row items-center justify-center gap-10">
					...
					<Link
						className={`group relative overflow-hidden transition-all duration-300 hover:text-[#ECBB4E] dark:hover:text-[#ECBB4E] ${route().current('event.front.show') ? 'text-[#ECBB4E] dark:text-[#ECBB4E]' : ''}`}
					>
						Open Recruitmen
						<span
							className={`absolute bottom-0 left-0 h-0.5 w-full origin-left transform bg-gradient-to-r from-[#ECBB4E]/90 to-[#ECBB4E] transition-all duration-300 ease-out ${route().current('event.front.show') ? 'translate-x-0' : '-translate-x-full'} group-hover:translate-x-0 dark:from-[#ECBB4E]/90 dark:to-[#ECBB4E]`}
						></span>
					</Link>

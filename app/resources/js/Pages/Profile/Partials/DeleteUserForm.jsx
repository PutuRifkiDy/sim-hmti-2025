	...
	return (
		<section className={`space-y-6 ${className}`}>
			<header>
				...
				<p className="mt-1 w-full text-sm text-gray-600 md:max-w-[400px]">
					Saat anda menghapus akun anda, semua data dan informasi akan dihapus secara permanen. Sebelum
					menghapus akun anda, tolong unduh data atau informasi yang anda inginkan untuk di simpan.
				</p>
			</header>
			...
			<Modal show={confirmingUserDeletion} onClose={closeModal}>
				<form onSubmit={deleteUser} className="p-6">
					<h2 className="text-lg font-medium text-gray-900">Apakah anda yakin ingin menghapus akun?</h2>

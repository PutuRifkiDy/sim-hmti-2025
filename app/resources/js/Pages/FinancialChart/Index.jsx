		...
		<>
			<div className="py-5">
				<div className="rounded-lg bg-white p-4 shadow dark:bg-[#1F1F1F] sm:p-8">
					...
					<Line className="mt-10" data={data} />
					<Line className="mt-10" data={dataAllPeriod} />
				</div>
			</div>
		</>
	);
...
Index.layout = (page) => (
	<DashboardLayout
		children={page}
		title={'Grafik Keuangan HMTI'}
		header={'Grafik Keuangan'}
		description={'Lihat Grafik Keuangan di periode ini'}
	/>
);

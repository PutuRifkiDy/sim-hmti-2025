...
export default function MasterHimpunan() {
    const { props } = usePage();
...
MasterHimpunan.layout = (page) => <DashboardLayout children={page} title={"Master Himpunan"} header={"Master Himpunan"} description={"Kelola master himpunan di page ini"} />;

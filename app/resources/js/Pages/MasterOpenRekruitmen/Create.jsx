...
export default function Create() {
	...
	useEffect(() => {
		if (isReadyToSubmit) {
			post(route('master-open-rekruitmen.store'), {
				...data,
				preserveScroll: true,
				preserveState: true,
				onError: () => {
...
Create.layout = (page) => <DashboardLayout children={page} title={'Create Master Open Recruitment'} />;

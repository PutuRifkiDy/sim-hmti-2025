...
export default function SeeRegistered() {
    ...
    const exportExcel = () => {
        import('xlsx').then((xlsx) => {
            ...
            const workbook = {
                Sheets: { master_oprecs_registered: worksheet },
                SheetNames: ['master_oprecs_registered'],
            };
    ...
    const renderHeader = () => {
        return (
            <div className="flex flex-col justify-between md:flex-row">
                <div className="justify-content-end export-buttons flex items-center gap-2">
    ...
    const reasonJoinTemplate = (rowData) => {
        ...
        return <div dangerouslySetInnerHTML={{ __html: cleanReasonJoin }} className="line-clamp-3 w-full" />;
    };

    const experienceTemplate = (rowData) => {
        const cleanExperience = DOMPurify.sanitize(rowData.experience);
        return <div dangerouslySetInnerHTML={{ __html: cleanExperience }} className="line-clamp-3 w-full" />;
    };
                ...
                <div className="flex flex-col justify-between gap-5 rounded-lg bg-white p-4 shadow dark:bg-[#1F1F1F] sm:p-8">
                    ...
                    <div className="flex w-full flex-row justify-between">
                        <header>
                            ...
                            <p className="mt-1 text-sm text-gray-600">Kelola daftar pendaftar di bawah ini.</p>
                        </header>
                        ...
                        <Button variant="gold" type="button" asChild>
                            <Link
                                ...
                                className="group flex flex-row items-center text-[14px] font-bold shadow-[0_0_15px_#ECBB4E] gap-1"
                            >
                    ...
                    <div className="mb-5 mt-2 grid grid-cols-1 gap-5 md:grid-cols-3">
                        ...
                        <div>
                            <InputLabel
                                ...
                                className="text-[12px] font-normal text-[#676767] dark:text-gray-400"
                            />
                            <p>{dateFormat(oprec.start_date)}</p>
                        </div>
                        <div>
                            <InputLabel
                                htmlFor="end_date"

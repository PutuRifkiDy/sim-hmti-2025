...
export default function ProgramKerjaSection({ title, img_path, description }) {
    ...
    return (
        ...
        >
            ...
            />
            <div
                className={`absolute inset-0 flex items-end p-4 transition-opacity duration-300 ${isHovered ? "opacity-0" : "md:group-hover:opacity-0"
                    }`}
                style={{
                    background:
            ...
            <div
                className={`absolute inset-0 bg-black bg-opacity-70 flex flex-col items-center justify-center text-center px-4 transition-opacity duration-300 ${isHovered ? "opacity-100" : "opacity-0 md:group-hover:opacity-100"
                    }`}
            >

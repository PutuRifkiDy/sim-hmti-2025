				...
				<div className="flex flex-col justify-between gap-5 rounded-lg bg-white p-4 shadow dark:bg-[#1F1F1F] sm:p-8">
					<div className="flex w-full flex-row justify-between">
						<header>
							...
							<p className="mt-1 text-sm text-gray-600">Update data mahasiswa di bawah ini</p>
						</header>
						...
						<div className="grid grid-cols-1 gap-5 md:grid-cols-2">
							...
							<div>
								...
								<TextInput
									...
									onErrors={
										errors.line_id && <InputError message={errors.line_id} className="mt-2" />
									}
								/>
							</div>
							...
							<div>
								...
								<TextInput
									...
									onErrors={
										errors.birthday && <InputError message={errors.birthday} className="mt-2" />
									}
								/>
							</div>
							...
							<div>
								...
								<TextInput
									...
									onErrors={
										errors.username && <InputError message={errors.username} className="mt-2" />
									}
								/>
							</div>

				...
				<div className="flex flex-col justify-between gap-5 rounded-lg bg-white p-4 shadow dark:bg-[#1F1F1F] sm:p-8">
					<div className="flex w-full flex-row justify-between">
						<header>
							...
							<p className="mt-1 text-sm text-gray-600">Update data sie di bawah ini</p>
						</header>
						...
						<Button variant="gold" type="button" asChild className="shadow-[0_0_15px_#ECBB4E]">
							<Link
								...
								className="group flex flex-row items-center text-[14px] font-bold"
							>
						...
						<div className="grid grid-cols-1 gap-5">
							<div>
								...
								<TextInput
									...
									onErrors={
										errors.sie_name && <InputError message={errors.sie_name} className="mt-2" />
									}
								/>
							</div>
						</div>

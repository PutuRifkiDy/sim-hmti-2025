...
export default function ProgramKerjaSection({ title, image, description }) {
  ...
  return (
    <div
      className={`relative aspect-[414/233] rounded-lg overflow-hidden cursor-pointer shadow-md w-full max-w-[414px] mx-auto border-2 border-[#E4B45C] group`}
